#!/usr/bin/env python3
"""Extract unique EN player-facing strings from Sunken WTS + JASS into JSONL."""
...
DEFAULT_WTS = ROOT / "sunken/extract/war3map.wts"
DEFAULT_JASS = ROOT / "sunken/extract/war3map.j"
DEFAULT_OUT = ROOT / "sunken/cache/en_strings.jsonl"
