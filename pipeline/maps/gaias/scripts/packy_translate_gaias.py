#!/usr/bin/env python3
"""Gaias-oriented Packy translator: auth-gate then delegate to scripts/packy_translate.py patterns."""
...
ENV = ROOT / ".env"
IN_DEFAULT = ROOT / "gaias/cache/en_strings.jsonl"
CACHE_DEFAULT = ROOT / "gaias/cache/packy_zh.json"
PROGRESS_DEFAULT = ROOT / "gaias/cache/progress.txt"
STATUS_DEFAULT = ROOT / "gaias/cache/status.txt"
